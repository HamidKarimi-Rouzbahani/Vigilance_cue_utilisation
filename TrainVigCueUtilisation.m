function TrainVigCueUtilisation(Subj)
...
Bias_in_target_side= 0.5; % (range: 0-1) >0.5 means more target on the left vs right; 0.5 means balanced
...
try
    ...
    for Block_Num=1:Num_of_conditions*Blocks_per_condition
        ...
        save(['Subj_',num2str(Subj),'_Blk_',num2str(Block_Num),'_',Condition_string,...
            '_train_CueUtilisation.mat'],'manually_deflected_top','top_events','top_events2','top_targets','top_targets2',...
