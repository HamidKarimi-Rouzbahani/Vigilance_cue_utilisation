function TestVigCueUtilisation_NS(Subj)
...
% modified by Hamid Karimi-Rouzbahani on 28/May/2022: disabled the beeps
...
% save('TestVigCueUtilisation_CB.mat','Cued_color_in_block','Block_condition',...
%     'Bias_in_target_side_subj','Num_of_conditions')
...
%                             beepIncorrect;
        ...
        save(['Subj_',num2str(Subj),'_Blk_',num2str(Block_Num),'_',Condition_string,...
            '_test_CueUtilisation_NS.mat'],'manually_deflected_top','top_events','top_events2','top_targets','top_targets2',...
